...
def process():
    ...
    summarized_text = summarizer(user_input, max_length = 1000, min_length = 0, do_sample = False)[0]['summary_text']

    return render_template("index1.html", user_input=user_input, translated_text=translated_text, summarized_text=summarized_text, languages=supported_languages, input_language=input_language)
